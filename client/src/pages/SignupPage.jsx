...
import { register as registerAction, reset } from '../features/authSlice';
          ...
          <div className="grid w-full gap-12 lg:grid-cols-[1.05fr,0.95fr] lg:items-center">
            ...
            >
              <h1 className="text-4xl font-semibold text-slate-900 dark:text-white">
                Join the pulse-driven teams.
              </h1>
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-300">
                Start sharing updates, unblock your peers, and keep momentum visible across the company.
              </p>
              <div className="mt-8 rounded-2xl border border-slate-200 bg-white/70 p-6 shadow-xl shadow-slate-200/60 backdrop-blur dark:border-slate-800 dark:bg-slate-900/60 dark:shadow-black/40">
                <div className="text-sm font-semibold text-slate-900 dark:text-white">Included with every account</div>
                <ul className="mt-4 space-y-3 text-sm text-slate-600 dark:text-slate-300">
                  <li className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-indigo-500" />
                    Private, searchable feed of updates.
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-indigo-500" />
                    Category tags that keep things organized.
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-indigo-500" />
                    Lightweight summaries for leadership.
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="rounded-3xl border border-slate-200 bg-white/80 p-8 shadow-2xl shadow-slate-200/60 backdrop-blur dark:border-slate-800 dark:bg-slate-900/70 dark:shadow-black/40">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-3xl font-semibold text-slate-900 dark:text-white">Create your account</h2>
                    <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Start sharing pulses with your team.</p>
                  </div>
